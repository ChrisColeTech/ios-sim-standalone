...
import type { SigCT2OAuthScreenProps } from '../../../../types/custom-apps/sigct2';

export function SigCT2OAuthScreen(props: SigCT2OAuthScreenProps) {
  ...
  return (
    ...
    >
      {props.isLoading && (
        <div className="h-[2px] w-full overflow-hidden bg-blue-400/30">
          <div className="h-full w-[40%] animate-pulse bg-blue-400" />
        </div>
      )}
      <webview
